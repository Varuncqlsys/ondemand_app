...
public class CalendarActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savePref.getUserType().equals("1")) {
            ...
            setContentView(R.layout.fragment_calender_seller);
        } else {
            setTheme(R.style.AppTheme);
            setContentView(R.layout.fragment_calender);
        }

        String event_date = getIntent().getStringExtra("event_date");
        ...
        Log.e("date", "here " + eventDay + " " + eventMonth + " " + eventYear);
        ...
        image_add_event = (ImageView) findViewById(R.id.image_add_event);
...
//        args.putInt(CaldroidFragment.YEAR, calendar.get(Calendar.YEAR));
        ...
        try {
            eventDate = outputFormat.parse(event_date);
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    private void getMeetings() {
        ...
        GetAsync mAsync = new GetAsync(context, AllOmorniApis.GET_CALENDER_MEETINGS, formBody) {
            @Override
                ...
                if (result != null && !result.equalsIgnoreCase("")) {
                    try {
                        ...
                        if (status.getString("code").equalsIgnoreCase("1")) {
                            ...
                            Utils.checkAuthToken(context, status.getString("auth_token"), status.getString("message"), savePref);
                        }
...
//                                }
        ...
        if (arrayList_selected.size() > 0) {
            meetingsAdapter = new MeetingsAdapter(context, arrayList_selected, CalendarActivity.this, false);
